...
public:
   ...
   Documento operator+(Documento doc);
};
...
public:
	...
	virtual bool imprime(Documento doc) = 0;
	virtual bool istonerBaixo() const = 0;
};
...
public:
   ...
   bool imprime(Documento doc);
   bool istonerBaixo() const;
};
...
public:
  ...
  string operator()(string printCode) const;
};
